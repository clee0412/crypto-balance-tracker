package edu.itba.cryptotracker.adapter.gateway.external.coingecko;

import edu.itba.cryptotracker.adapter.gateway.external.coingecko.config.CoingeckoApiConfig;
import edu.itba.cryptotracker.adapter.gateway.external.coingecko.dto.CoingeckoCryptoInfoDTO;
import edu.itba.cryptotracker.adapter.gateway.external.coingecko.dto.CoingeckoPricesDTO;
import edu.itba.cryptotracker.adapter.gateway.external.coingecko.mapper.CoingeckoApiMapper;
import edu.itba.cryptotracker.domain.exception.ExternalApiException;
import edu.itba.cryptotracker.adapter.gateway.httpclient.HttpClient;
import edu.itba.cryptotracker.adapter.gateway.httpclient.dto.HttpRequest;
import edu.itba.cryptotracker.usecase.crypto.port.output.CryptoProviderPort;
...
public class CoingeckoGateway implements CryptoProviderPort {
