package edu.itba.cryptotracker.web.output.persistence.jpa;

import edu.itba.cryptotracker.infrastructure.persistence.jpa.PlatformJpaGatewayImpl;
import edu.itba.cryptotracker.infrastructure.persistence.jpa.PlatformJpaRepository;
...
class PlatformJpaAdapterTest {
    ...
    private PlatformJpaGatewayImpl adapter;

    @BeforeEach
    void setUp() {
        adapter = new PlatformJpaGatewayImpl(jpaRepository, mapper);
    }
